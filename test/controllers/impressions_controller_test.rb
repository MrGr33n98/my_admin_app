...
class ImpressionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create impression" do
    assert_difference("Impression.count") do
      post impressions_url, params: { impression: { company_id: @impression.company_id, date: @impression.date, impression_type: @impression.impression_type, value: @impression.value } }
    end
  ...
  test "should update impression" do
    patch impression_url(@impression), params: { impression: { company_id: @impression.company_id, date: @impression.date, impression_type: @impression.impression_type, value: @impression.value } }
