...
class CompanyCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create company_category" do
    assert_difference("CompanyCategory.count") do
      post company_categories_url, params: { company_category: { category_id: @company_category.category_id, company_id: @company_category.company_id } }
    end
  ...
  test "should update company_category" do
    patch company_category_url(@company_category), params: { company_category: { category_id: @company_category.category_id, company_id: @company_category.company_id } }
